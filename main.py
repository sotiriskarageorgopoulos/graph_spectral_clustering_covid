...
countries = pd.read_csv("./data/eu_countries.csv")["countryterritoryCode"].to_numpy() #EU countries

#Cluster of countries according to cases and deaths before vaccinations

covid_stats_bef_vacc = pd.read_csv("./data/covid_19(2020).csv")[["cases","deaths","countryterritoryCode"]]
...
covid_stats_after_vacc = pd.read_csv("./data/covid_19(2021-2022).csv")[["cases","deaths","countryterritoryCode"]]
